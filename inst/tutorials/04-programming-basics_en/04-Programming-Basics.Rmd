...
![](https://vimeo.com/220490105){target="_blank}
...
![](https://vimeo.com/220490157){target="_blank}
...
Use `rnrom()` to generate 100 random normal values with a mean of 100 and a standard deviation of 50.
...
![](https://vimeo.com/220493412){target="_blank}
...
![](https://vimeo.com/220490316){target="_blank}
...
![](https://vimeo.com/220490241){target="_blank}
...
![](https://vimeo.com/220490360){target="_blank}
...
![](https://vimeo.com/220490447){target="_blank}
...
But what if the package that you want to load is not installed on your computer? How would you install the {sudoku} package on your own computer?
