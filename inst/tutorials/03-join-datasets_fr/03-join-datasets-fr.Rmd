...
Ce module utilise les [packages de base du tidyverse](http://tidyverse.org/){target="_blank}, notamment {dplyr}, ainsi que le package {nycflights13}. Tous ces packages ont été préinstallés et préchargés.
