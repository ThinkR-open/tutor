...
```{r bnames, echo = FALSE, message = FALSE, warning = FALSE, out.width = "90%"}
babynames |> 
...
Another way of writing sequences of functions is to use : the pipe.
...
As you read the code, pronounce `|>` as "then". Each function name is a verb, so our code resembles the statement, "Take babynames, _then_ filter it by name and sex, _then_ select the name and n columns, _then_ arrange the results by descending values of n."
