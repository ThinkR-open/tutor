...
```{r}
p1 + 
  annotate("text", x = 4, y = 7500, label = "There are no cheap,\nlarge diamonds")
```
...
You can see the complete list of scale names at [http://ggplot2.tidyverse.org/reference/](http://ggplot2.tidyverse.org/reference/){target="_blank}. In this tutorial, we will focus on scales that work with the color aesthetic.
...
The RColorBrewer package contains a variety of palettes developed by Cynthis Brewer. Each palette is designed to look pleasing as well as to differentiate between the values represented by the palette. You can learn more about the color brewer project at [colorbrewer2.org](http://colorbrewer2.org){target="_blank}.
...
```{r out.width = "80%"}
p1 + 
  scale_color_brewer(name = "Cut Grade", 
