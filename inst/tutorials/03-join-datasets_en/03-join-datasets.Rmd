...
This tutorial uses the [core tidyverse packages](http://tidyverse.org/){target="_blank}, including dplyr, as well as the nycflights13 package. All of these packages have been pre-installed and pre-loaded for your convenience.
...
If you'd like to refresh your understanding of lists in R, revisit the [Programming Basics](https://rstudio.cloud/learn/primers/1.2){target="_blank} tutorial.
