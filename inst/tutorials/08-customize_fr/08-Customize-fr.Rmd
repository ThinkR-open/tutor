...
Le module est adapté du livre _R for Data Science_ de Hadley Wickham et Garrett Grolemund, publié par O'Reilly Media, Inc. 2016, ISBN : 9781491910399. Vous pouvez acheter le livre sur [shop.oreilly.com](http://shop.oreilly.com/product/0636920034407.do){target="_blank}.
...
Vous pouvez consulter la liste complète des noms d'échelle à l'adresse suivante : [http://ggplot2.tidyverse.org/reference/](http://ggplot2.tidyverse.org/reference/){target="_blank}. Dans ce module, nous allons nous concentrer sur les échelles qui fonctionnent avec le paramètre esthétique `color`.
