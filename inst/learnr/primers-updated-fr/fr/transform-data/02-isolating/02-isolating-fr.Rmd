...
Il existe également une série d'outils appelés "helpers" fournie avec `select()` et destinée à nous faciliter la vie. Par exemple, si vous placez un signe '-' devant un nom de colonne, `select()` renverra toutes les colonnes sauf cette colonne. Pouvez-vous prédire comment le signe moins va fonctionner ici ?
